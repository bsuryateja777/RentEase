...
export const RentEaseLogo = ({ size }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`${size} text-primary hover:text-primaryHover font-bold `}>
...
export const SearchIcon = ({ size }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`${size}text-white cursor-pointer`}>
